            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      const Text("TOTAL ENERGY", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
                      const SizedBox(height: 4),
                      Text("$totalEnergy", style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                    ],
                  ),
